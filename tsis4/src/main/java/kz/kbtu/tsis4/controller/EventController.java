...
public class EventController {
    ...
    @PostMapping
    public EventResponseDto createEvent(@RequestBody EventCreateDto dto){
        return eventService.create(dto);
    }

    //PATCH EVENT
    @PatchMapping("/{id}")
    public EventResponseDto updateEvent(@PathVariable UUID id, @RequestBody EventUpdateDto dto){
